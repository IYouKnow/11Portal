...
const themeVariables: Record<ResolvedTheme, Record<string, string>> = {
  ...
  dark: {
    ...
    "--color-window-chrome": "10 14 24",
    "--color-selection": "56 189 248",
    "--grid-line": "255 255 255",
    "--body-background":
      "radial-gradient(circle at top, rgba(125, 211, 252, 0.14), transparent 30%), linear-gradient(180deg, #0b0b0d 0%, #09090b 100%)",
    "--body-overlay":
      "radial-gradient(circle at 0% 0%, rgba(255, 255, 255, 0.05), transparent 24%), radial-gradient(circle at 100% 0%, rgba(125, 211, 252, 0.12), transparent 26%)",
    ...
    "--app-top-glow": "linear-gradient(180deg, rgba(255, 255, 255, 0.06), transparent)",
  },
};
